...
class $TestResultsTable extends TestResults
  ...
  late final GeneratedColumn<String> category = GeneratedColumn<String>(
      ...
      requiredDuringInsert: false,
      defaultValue: const Constant('ETC'));
  ...
  late final GeneratedColumn<String> fwVersion = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _testToolVersionMeta =
      const VerificationMeta('testToolVersion');
  @override
  late final GeneratedColumn<String> testToolVersion = GeneratedColumn<String>(
      'test_tool_version', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _securityPatchMeta =
      const VerificationMeta('securityPatch');
  @override
  late final GeneratedColumn<String> securityPatch = GeneratedColumn<String>(
      'security_patch', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _sdkVersionMeta =
      const VerificationMeta('sdkVersion');
  @override
    ...
    if (data.containsKey('test_tool_version')) {
      context.handle(
          ...
          testToolVersion.isAcceptableOrUnknown(
              data['test_tool_version']!, _testToolVersionMeta));
    }
    if (data.containsKey('security_patch')) {
      context.handle(
          _securityPatchMeta,
          securityPatch.isAcceptableOrUnknown(
              data['security_patch']!, _securityPatchMeta));
    }
  ...
  TestResult map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TestResult(
      ...
      testToolVersion: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}test_tool_version']),
      securityPatch: attachedDatabase.typeMapping
...
class TestResult extends DataClass implements Insertable<TestResult> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || testToolVersion != null) {
      map['test_tool_version'] = Variable<String>(testToolVersion);
    }
    if (!nullToAbsent || securityPatch != null) {
  ...
  TestResultsCompanion toCompanion(bool nullToAbsent) {
    return TestResultsCompanion(
      ...
      fwVersion: fwVersion == null && nullToAbsent
          ? const Value.absent()
          : Value(fwVersion),
      testToolVersion: testToolVersion == null && nullToAbsent
          ? const Value.absent()
          : Value(testToolVersion),
      securityPatch: securityPatch == null && nullToAbsent
          ? const Value.absent()
          : Value(securityPatch),
  ...
  TestResult copyWith(
      ...
      TestResult(
        ...
        testToolVersion: testToolVersion.present
            ? testToolVersion.value
            : this.testToolVersion,
        securityPatch:
...
class $$TestResultsTableFilterComposer
  ...
  ColumnFilters<String> get securityPatch => $composableBuilder(
      column: $table.securityPatch, builder: (column) => ColumnFilters(column));
...
class $$TestResultsTableAnnotationComposer
  ...
  GeneratedColumn<String> get testToolVersion => $composableBuilder(
      column: $table.testToolVersion, builder: (column) => column);

  GeneratedColumn<String> get securityPatch => $composableBuilder(
      column: $table.securityPatch, builder: (column) => column);
