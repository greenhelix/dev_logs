    ...
    public void testDownloadSpeed(Test3Callback callback) {
        ...
        new Thread(() -> {
            ...
            try {
                ...
                handler.post(() -> callback.onTestProgress(20, "Downloading test file..."));
                        ...
                        if (elapsedSeconds > 0) {
                            ...
                            handler.post(() -> {
                                callback.onTestProgress(progress,
                                        String.format("Downloading: %.2f MB/s", currentSpeed));
                ...
                handler.post(() -> callback.onError("Download test failed: " + e.getMessage()));
            } finally {
                try {
