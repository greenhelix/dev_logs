...
//		String name = SystemProperties.get(PROP_MODEL, "");
	...
	public String getEthernetMac() {
		...
		String mac = FileUtils.readFromFile(SYSFS_ETH0_MAC);
	...
	public String getWifiMac() {
		...
		String mac = FileUtils.readFromFile(SYSFS_WIFI_MAC);
	...
	public String getIpAddress() {
		...
		if (network == null) {
			LogManager.d(TAG, "getIpAddress ActiveNetwork null --");
			return null;
		}
